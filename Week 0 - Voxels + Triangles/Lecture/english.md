...
We add the current vertexIndex to the triangles when setting the triangles to make sure that the triangles are refering to their set of vertices and not the previous set.
