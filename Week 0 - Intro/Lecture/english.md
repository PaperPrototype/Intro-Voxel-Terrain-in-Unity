...
### vertices
A mesh is really just some information on how to represent a shape. Most meshes are sets of three positions to make triangles to represent their shape. This is because triangles can be used to make any other shape. In Unity's mesh format a triangle is made using 3 positions in space. Actually the "correct" word used for "positions in space" is Vertices. In Unity its just a Vector3. Lets make a triangle using 3 vertices.
